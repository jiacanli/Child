...
public class ResultMapUtils {
	...
	public static final String PARAM_ERROR_KEY = "-0001";
	public static final String PARAM_ERROR = "参数错误";
	
	public static final String GET_ERROR_KEY = "-0002";
	public static final String GET_ERROR_VALUE = "获取信息失败";
	public static final String UPDATE_ERROR_KEY = "-0003";
	public static final String UPDATE_ERROR_VALUE = "更新数据失败";
	public static final String DELETE_ERROR_KEY = "-0004";
	public static final String DELETE_ERROR_VALUE = "删除数据失败";
	public static final String INSERT_ERROR_KEY = "-0005";
	public static final String INSERT_ERROR_VALUE = "新增数据失败";
	
	public static final String PIC_UPLOAD_ERROR_KEY = "-0006";
	public static final String PIC_UPLOAD_ERROR = "图片上传失败";
	
	public static final String SOUND_UPLOAD_ERROR_KEY="-0007";
	public static final String SOUND_UPLOAD_ERROR = "音频下载失败";
	
	public static final String MSG_RECIEVER_NULL_KEY = "-0008";
	public static final String MSG_RECIEVER_NULL = "收信人为空";
